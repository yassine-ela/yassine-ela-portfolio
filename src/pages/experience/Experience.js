...
import exp from "../../assests/images/experience.png";
// const experience = {
// 	title: "Experience",
  ...
  render() {
    ...
    return (
      <div className="experience-main">
          ...
          <Fade bottom duration={2000} distance="40px">
            <div className="experience-heading-div">
              <div className="experience-heading-img-div">
                <img style={{ height: "50%", width: "50%" }} src={exp} alt="" />
                {/** 
        ...
        <ExperienceCard
        index={index} totalCards={section["experiences"].length} experience={experience} theme={theme}
        />
        ))  */}
